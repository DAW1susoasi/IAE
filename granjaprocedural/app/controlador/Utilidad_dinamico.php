<?php
class Utilidad_dinamico extends ControladorPrincipal{
    //private $modelo;
        ...
        <thead class="thead-dark">
            <tr>
             ...
             <tr>
                ...
                <td></td>
                <td></td>
                <td><input class="text-center" id="utilidad" name='utilidad' type='text' style="width:125px" required/></td>
                <td></td>
                <td></td>
    ...
    <?php
      if(isset($_POST["utilidad"]) && $r = $this->modelo->listarUtilidad($_POST["utilidad"])){
        foreach($this->modelo->listarUtilidad($_POST["utilidad"]) as $r):
    ?>            
          <tr>
